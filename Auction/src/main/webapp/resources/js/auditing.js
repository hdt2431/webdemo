		...
		if (confirm("确认删除吗？")) {
			$.ajax({
				...
				success : function(result) {
					window.location.href = "auditing.jsp?state_id="+state_id;
...
function build_arts_table(result) {
	...
	$.each(arts, function(index, item) {
		...
		moreBtn.click(function(){
			...
			"layui-btn layui-btn-normal")
			.append("审核未通过");
			var image = $('<div style="height: 100px;width:1000px;margin-bottom: 30px;"></div>').append('<img src="../resources/images/青花瓷.jpg" style="height: 100%">')
			.append('<img src="../resources/images/111.jpg" style="height: 100%">')
			.append('<img src="../resources/images/222.jpg" style="height: 100%">')
			.append('<img src="../resources/images/333.jpg" style="height: 100%">')
			.append('<img src="../resources/images/444.jpg" style="height: 100%">');
			...
			auditing_btn.click(function() {
				...
				$.ajax({
					...
					type : "get",
					success : function(result) {
						window.location.href = "auditing.jsp?state_id=1";
					}
				});
				}
			});
		...
		set_btn.click(function() {
			...
			submit_btn.click(function(){
				$.ajax({
					...
					success : function(result) {
						if(result.code==100)
						window.location.href = "auditing.jsp?state_id=2";
						else
							alert("false");
					}
				});
