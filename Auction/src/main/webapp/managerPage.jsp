...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item layui-nav-itemed"><a class=""
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="jsp/auditing2.jsp?state_id=1">未审核拍品</a>
							</dd>
							<dd>
								<a href="jsp/auditing2.jsp?state_id=2">审核通过拍品</a>
							</dd>
							<dd>
								<a href="jsp/auditing2.jsp?state_id=5">未审核通过拍品</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;">发布新闻</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="jsp/news2.jsp">新添新闻</a>
							</dd>
						</dl></li>
					<li class="layui-nav-item"><a href="javascript:;">管理员管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="jsp/managerList.jsp">管理员列表</a>
							</dd>
						</dl></li>
				</ul>
			</div>
		...
		<div class="layui-body">
			<!-- 内容主体区域 -->
			<div style="padding: 15px;"><h1>欢迎您，管理员1</h1></div>
		</div>
