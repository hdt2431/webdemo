...
<script type="text/javascript"
	src="${APP_PATH }/resources/js/typeList.js" charset="UTF-8"></script>
...
<body class="layui-layout-body">
		...
		<div class="layui-body">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">拍卖会列表</a>
				</div>
				<button type="button"
				...
				<div class="modal-body" id="manager">
					<form>
						<div class="input-group">
							<span class="input-group-addon" id="sizing-addon2">拍卖会名</span> <input
								type="text" class="form-control" name="type_name"
								aria-describedby="sizing-addon2">
						</div>
						<div class="input-group">
							<span class="input-group-addon" id="sizing-addon2">拍卖会描述</span> <input
								type="text" class="form-control" name="type_desc"
								aria-describedby="sizing-addon2">
						</div>
					</form>
				</div>
	...
	<%=session.getAttribute("Manager_INFO")%>
		...
		$("#submit").click(function(){
			$.ajax({
				url : "http://localhost:8080/Auction/addtype",
